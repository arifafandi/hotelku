...
<body class="">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="javascript:void(0);" class="btn btn-info btn-sm" data-toggle="modal" data-target="#modal-edit<?php echo $group->id; ?>"><i class="feather icon-edit"></i>&nbsp;Edit </a>
                                                    <a href="javascript:void(0);" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#modal-delete<?php echo $group->id; ?>"><i class="feather icon-trash-2"></i>&nbsp;Delete </a>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                    </tbody>
    ...
    foreach ($groups['groups'] as $group) :
    ?>
        <div class="modal fade" id="modal-delete<?php echo $group->id; ?>">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        Delete Group <?php echo $group->name; ?>?
                    </div>
    ...
    foreach ($groups['groups'] as $group) :
    ?>
        <div class="modal fade" id="modal-edit<?php echo $group->id; ?>">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <?php echo form_open('admin/edit_group/' . $group->id); ?>
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label class="floating-label" for="Name">Name</label>
                                    <input name="name" type="text" class="form-control" id="Name" value="<?php echo $group->name; ?>" required="">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label class="floating-label" for="Description">Description</label>
                                    <input name="description" type="text" class="form-control" id="Description" value="<?php echo $group->description; ?>" required="">
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <button type="submit" name="submit" class="btn btn-primary">Submit</button>
